...
import com.navana.restapi.config.security.JwtTokenProvider;
import com.navana.restapi.controller.advice.exception.CEmailSigninFailedException;
...
public class SignController {
    ...
    public SingleResult<String> signin(@ApiParam(value = "회원ID : 이메일", required = true) @RequestParam String id,
        ...
        if (!passwordEncoder.matches(password, ((User) user).getPassword()))
